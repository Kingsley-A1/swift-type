            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-gray-900 dark:bg-white px-4 py-3 text-sm font-semibold text-white dark:text-gray-900 transition-all hover:bg-gray-700 dark:hover:bg-gray-100 active:scale-[0.99] disabled:opacity-60"
                >
                  {isLoading ? (
              ...
              <div className="space-y-2.5">
                ...
                <button
                  disabled
                  type="button"
                  className="relative flex w-full cursor-not-allowed items-center justify-center gap-2.5 rounded-xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/3 px-4 py-3 text-sm font-semibold text-gray-400 transition-all"
                >
                  ...
                  Google
                  <span className="absolute right-3 rounded bg-gray-200 dark:bg-white/10 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                    Soon
                  </span>
                </button>
              </div>
