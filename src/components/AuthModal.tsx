                ...
                <>
                  ...
                  <div className="space-y-2.5">
                    <button
                      ...
                      onClick={() => {
                        if (!hasGitHubProvider) return;
                        void signIn("github", { callbackUrl: "/" });
                      }}
                      className={`flex w-full items-center justify-center gap-2.5 rounded-xl border border-gray-200 dark:border-white/10 px-4 py-3 text-sm font-semibold transition-all ${
                        hasGitHubProvider
                          ? "bg-white dark:bg-white/5 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/10 active:scale-[0.98]"
